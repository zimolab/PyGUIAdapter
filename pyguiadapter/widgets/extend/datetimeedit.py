...
class DateTimeEdit(CommonParameterWidget):
    Self = TypeVar("Self", bound="DateTimeEdit")
    ...
    def __init__(
        ...
        self._config: DateTimeEditConfig = config
    ...
    def _setup_widgets(self):
        if self._config.min_datetime is not None:
            self._value_widget.setMinimumDateTime(QDateTime(self._config.min_datetime))

        if self._config.max_datetime is not None:
            self._value_widget.setMaximumDateTime(QDateTime(self._config.max_datetime))
