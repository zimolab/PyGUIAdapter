...
class Ui_ExecutionWindow(object):
    def setupUi(self, ExecutionWindow):
        ...
        self.textbrowser_document = QtWidgets.QTextBrowser(parent=self.dockwidget_content_2)
        self.textbrowser_document.setOpenExternalLinks(True)
        self.textbrowser_document.setObjectName("textbrowser_document")
        self.vlayout_2.addWidget(self.textbrowser_document)
        ...
        self.textbrowser_output = QtWidgets.QTextBrowser(parent=self.dockwidget_content)
        self.textbrowser_output.setOpenExternalLinks(False)
        self.textbrowser_output.setObjectName("textbrowser_output")
        self.vlayout_3.addWidget(self.textbrowser_output)
