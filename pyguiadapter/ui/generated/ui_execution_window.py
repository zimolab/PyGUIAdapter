...
class Ui_ExecutionWindow(object):
    def setupUi(self, ExecutionWindow):
        ...
        self.layout_progressbar = QtWidgets.QVBoxLayout()
        self.layout_progressbar.setObjectName("layout_progressbar")
        ...
        self.layout_progressbar.addWidget(self.progressbar)
        ...
        self.layout_progressbar.addWidget(self.label_progressbar_info)
        self.vlayout_3.addLayout(self.layout_progressbar)
